...
! /*!< [1/0] Preserve edges at interface of 2 domains with same reference */
#define     MMG2D_IPARAM_opnbdy             5
! /*!< [-1/0/1/2] Lagrangian option */
#define     MMG2D_IPARAM_lag                6
! /*!< [0/1/2] Read/write to gmsh visu if val=1 (out) if val=2 (in/out) */
#define     MMG2D_IPARAM_msh                7
! /*!<only if no given triangle save the subdomain nb (0==all subdomain) */
#define     MMG2D_IPARAM_numsubdomain        8
